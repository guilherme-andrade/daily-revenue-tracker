class DailyReport < ApplicationRecord
  belongs_to :user
  before_create :calculate_kreditkarte_total
  before_create :calculate_cash_revenues

  validates_presence_of :summe_treuekarte, :on => :create, :message => "can't be blank"
  validates_presence_of :summe_rechnung, :on => :create, :message => "can't be blank"
  validates_presence_of :summe_rabatte, :on => :create, :message => "can't be blank"
  validates_presence_of :summe_gutschein, :on => :create, :message => "can't be blank"
  validates_presence_of :summe_lunchchecks, :on => :create, :message => "can't be blank"
  validates_presence_of :summe_einkauf, :on => :create, :message => "can't be blank"
  validates_presence_of :maestro, :on => :create, :message => "can't be blank"
  validates_presence_of :mastercard, :on => :create, :message => "can't be blank"
  validates_presence_of :visa, :on => :create, :message => "can't be blank"
  validates_presence_of :andere, :on => :create, :message => "can't be blank"
  validates_presence_of :lunch_umsatz, :on => :create, :message => "can't be blank"
  validates_presence_of :dinner_umsatz, :on => :create, :message => "can't be blank"
  validates_presence_of :lunch_anzahl_personen, :on => :create, :message => "can't be blank"
  validates_presence_of :dinner_anzahl_personen, :on => :create, :message => "can't be blank"
  ...
  def calculate_cash_revenues
    self.bar = self.total_umsatz - total_not_cash
  end
